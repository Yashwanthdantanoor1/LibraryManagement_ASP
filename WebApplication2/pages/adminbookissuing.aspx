<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="WebApplication2.pages.adminbookissuing" %>
            ...
            <div class="col-md-5 mx-auto">
                <div class="card">
                    <div class="card-body">
                     ...
                     <div class="row">
                           <div class="col-md-6">
                                <asp:Button  class="btn btn-primary btn-block" ID="Button2" runat="server" Text="Issue" /> 
                            </div>
                             <div class="col-md-6">
